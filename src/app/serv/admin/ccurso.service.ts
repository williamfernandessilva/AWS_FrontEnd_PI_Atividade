...
export class CcursoService {
  private apiUrl = 'https://ativpi.duckdns.org/course/';  // URL principal para cursos
  private disciplinesUrl = 'https://ativpi.duckdns.org/subject/';  // URL para buscar as disciplinas
